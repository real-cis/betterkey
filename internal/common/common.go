...
type ClusterConfig struct {
	...
	EnforceSealQuoteVerify       bool     `env:"TDX_SEAL_ENFORCE_QUOTE_VERIFY" envDefault:"true"`
	EnforceKeyRequestQuoteVerify bool     `env:"TDX_KEYREQ_ENFORCE_QUOTE_VERIFY" envDefault:"true"`
